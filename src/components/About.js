...
const About = ({ classes }) => (
  <Paper square={true} elevation={11} className={classes.root}>
    ...
    <Paper square={true} elevation={12} className={classes.root}>
      ...
      <Typography variant="h6" paragraph style={{ padding: "1em" }}>
        ...
        sharing easier:{" "}
        <a href="http://bit.ly/flatiron-student-resources">link</a> If you have
        any questions, DM meg-gutshall on Flatiron's Slack.
      </Typography>

      <Typography variant="h6" paragraph style={{ padding: "2em" }}>
